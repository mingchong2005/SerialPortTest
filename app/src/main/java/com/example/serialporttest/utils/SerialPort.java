...
package com.example.serialporttest.utils;
...
public class SerialPort {
	...
	private native FileDescriptor nativeSerialPortOpen(String path, int baudrate);
	public native int nativeSerialPortClose();
